...
| ![img](mdpic/20201026211558-20240202110425246.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201026211647-20240202110425251.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201027131316-20240202110425240.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201027131612-20240202110425253.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201027133500-20240202110425252.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201027202040-20240202110425255.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201107133850-20240202110425280.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201107134331-20240202110425280.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201107134917-20240202110425289.png) |
| :------------------------------------------------: |

**冲突后**

| ![img](mdpic/20201107134951-20240202110425283.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201107140647-20240202110425291.png) |
| :------------------------------------------------: |

- ht[0].used当前的值为4，4*2=8，所以程序会将ht[1]哈希表的大小设置为8。下图展示了ht[1]在分配空间之后，字典的样子

| ![img](mdpic/20201107140815-20240202110425289.png) |
| :------------------------------------------------: |

- 将ht[0]包含的四个键值对都**rehash**到ht[1]

| ![img](mdpic/20201107140838-20240202110425316.png) |
| :------------------------------------------------: |

- 释放ht[0]，并将ht[1]设置为ht[0]，然后为ht[1]分配一个空白哈希表，如下图所示。至此，对哈希表的扩展操作执行完毕，程序成功将哈希表的大小从原来的4改为了现在的8

| ![img](mdpic/20201107141210-20240202110425314.png) |
| :------------------------------------------------: |
...
根据BGSAVE命令或BGREWRITEAOF命令是否正在执行，服务器执行扩展操作所需的负载因子并不相同，这是因为在执行BGSAVE命令或BGREWRITEAOF命令的过程中，Redis需要创建当前服务器进程的子进程，而大多数操作系统都采用写时复制（-on-write）技术来优化子进程的使用效率，所以在子进程存在期间，服务器会提高执行扩展操作所需的负载因子，从而**尽可能地避免在子进程存在期间进行哈希表扩展操作，这可以避免不必要的内存写入操作，最大限度地节约内存**。
...
| ![img](mdpic/20201107151610-20240202110425323.png) |
| :------------------------------------------------: |

- 开始rehash，rehash索引为0的键值对

| ![img](mdpic/20201107151709-20240202110425328.png) |
| :------------------------------------------------: |

- rehash索引为1的键值对

| ![img](mdpic/20201107151744-20240202110425329.png) |
| :------------------------------------------------: |

- … 依次rehash
- rehash完成，rehashidx再次变为-1

| ![img](mdpic/20201107151834-20240202110425344.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201107211857-20240202110425316.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201107212138-20240202110425347.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201107212157-20240202110425346.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201108152446-20240202110425360.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201108100544-20240202110425360.png) |
| :------------------------------------------------: |

设置负无穷后，若要查找元素2，过程如下图所示

| ![img](mdpic/20201108100641-20240202110425357.png) |
| :------------------------------------------------: |

**插入图解**

- 若我们要将45插入到跳跃表中| ![img](mdpic/20201107214001-20240202110425396.png) |
| :------------------------------------------------: |
- 先找到插入位置，将45插入到合适的位置| ![img](mdpic/20201107214125-20240202110425373.png) |
| :------------------------------------------------: |
- 抛掷硬币：**为正**，晋升| ![img](mdpic/20201107214603-20240202110425374.png) |
| :------------------------------------------------: |
- 假设硬币一直为正，插入元素一路晋升，当晋升的次数超过跳跃表的层数时，**需要再创建新的链表以放入晋升的插入元素。新创建的链表的头结点为负无穷**| ![img](mdpic/20201107214928-20240202110425378.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201108155128-20240202110425412.png) |
| :------------------------------------------------: |
...
- backward：前驱指针，用于保存节点的前驱节点，**每个节点只有一个backward**
  - 例：如果要从第四层的节点访问第三层的节点，则可以通过backward直接访问| ![img](mdpic/20201108160050-20240202110425389.png) |
  | :------------------------------------------------: |
- level[]：节点的层，每个节点拥有1~32个层，除头结点外（32层），其他节点的层数是随机的。**注意**：Redis中没有使用抛硬币的晋升策略，而是直接随机一个层数值。下图展示了层数不同的几个节点| ![img](mdpic/20201108160122-20240202110425409.png) |
  | :------------------------------------------------: |
...
| ![img](mdpic/20201108162654-20240202110425412.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201113112602-20240202110425411.png) |
| :------------------------------------------------: |
...
- contents：为intset的底层实现，用于存放不重复的元素，且**元素按照从小到大的顺序排列。数组类型由encoding决定，与int8_t无关**
  ...
  | ![img](mdpic/20201113113802-20240202110425422.png) |
  | :------------------------------------------------: |
...
| ![img](mdpic/20201113113502-20240202110425429.png) |
| :------------------------------------------------: |
...
- 假设现在有一个INTSET_ENC_INT16编码的整数集合，**集合中包含三个int16_t类型的元素**
  ...
  | ![img](mdpic/20201113114715-20240202110425445.png) |
| :------------------------------------------------: |

  - 因为contents中的元素都是16位的，3个数组共占用空间48位，如下

  | ![img](mdpic/20201113114838-20240202110425435.png) |
| :------------------------------------------------: |
...
- 这时，需要将65535添加到整数集合里面，因为int16_t能够表示的范围为(-32768~32767)，无法容纳该数字，所以**需要升级**。升级过程如下
  ...
  | ![img](mdpic/20201113115436-20240202110425445.png) |
  | :------------------------------------------------: |

  - 将数组中的元素**类型改为int32_t**，并放入扩展后的contents中。最后添加新插入的元素。
| ![img](mdpic/20201113115536-20240202110425442.png) |
| :------------------------------------------------: |
| ![img](mdpic/20201113115550-20240202110425452.png) |
| :------------------------------------------------: |
| ![img](mdpic/20201113115604-20240202110425460.png) |
| :------------------------------------------------: |
| ![img](mdpic/20201113115811-20240202110425460.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201113115909-20240202110425497.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201113162812-20240202110425497.png) |
| :------------------------------------------------: |

- 当**一个哈希键只包含少量键值对，比且每个键值对的键和值要么就是小整数值，要么就是长度比较短的字符串**，那么Redis就会使用压缩列表来做哈希键的底层实现

| ![img](mdpic/20201113162843-20240202110425489.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201113163516-20240202110425488.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201113164801-20240202110425499.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116193058-20240202110425534.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201117210043-20240202110425488.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201117210218-20240202110425538.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116090708-20240202110425529.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116154658-20240202110425539.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116153722-20240202110425535.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116153707-20240202110425540.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116154107-20240202110425596.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116155237-20240202110425584.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201116155653-20240202110425570.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201117214036-20240202110425570.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201117215013-20240202110425575.png) |
| :------------------------------------------------: |

| ![img](mdpic/20201117215302-20240202110425566.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201117215430-20240202110425604.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201117215556-20240202110425569.png) |
| :------------------------------------------------: |

**使用hashtable**

| ![img](mdpic/20201117215637-20240202110425600.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201118192800-20240202110425594.png) |
| :------------------------------------------------: |

其结构如下图所示

| ![img](mdpic/20201118192819-20240202110425604.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201118192946-20240202110425615.png) |
| :------------------------------------------------: |

其结构如下图所示

| ![img](mdpic/20201118193015-20240202110425622.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201118194654-20240202110425627.png) |
| :------------------------------------------------: |

其结构如下图所示

| ![img](mdpic/20201118194930-20240202110425642.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201118201719-20240202110425644.png) |
| :------------------------------------------------: |

**字典和跳表中的数据**

| ![img](mdpic/20201118201736-20240202110425645.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201118200641-20240202110425647.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119143917-20240202110425645.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119144559-20240202110425657.png) |
| :------------------------------------------------: |

那么，redisServer中的saveparams数组的结构如下

| ![img](mdpic/20201119144621-20240202110425683.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119150042-20240202110425676.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119150935-20240202110425670.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119153503-20240202110425683.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119154720-20240202110425682.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119155315-20240202110425685.png) |
| :------------------------------------------------: |

| ![img](mdpic/20201119155330-20240202110425696.png) |
| :------------------------------------------------: |

| ![img](mdpic/20201119155427-20240202110425725.png) |
| :------------------------------------------------: |

| ![img](mdpic/20201119155437-20240202110425752.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119160522-20240202110425725.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119201211-20240202110425734.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122141436-20240202110425726.png) |
| :------------------------------------------------: |

那么在这些命令执行之后，数据库的键空间的结构如下

| ![img](mdpic/20201122141457-20240202110425736.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122143614-20240202110425770.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119213618-20240202110425766.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119205735-20240202110425792.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119205814-20240202110425808.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201119205917-20240202110425799.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120165728-20240202110425808.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120171043-20240202110425830.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120171229-20240202110425865.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120171742-20240202110425859.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201121084911-20240202110425835.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120175242-20240202110425846.png) |
| :------------------------------------------------: |

因为是第一次连接，所以会进行**完整重同步**，从服务器发送SYNC指令，主服务器执行BGSAVE，并将RDB文件发送给从服务。发送后再将缓冲区中的数据发送给从服务器

| ![img](mdpic/20201120175357-20240202110425848.png) |
| :------------------------------------------------: |

完全重同步后，主从服务器的偏移量相同，此后开始**命令传播**过程

| ![img](mdpic/20201120175428-20240202110425867.png) |
| :------------------------------------------------: |

| ![img](mdpic/20201120175455-20240202110425867.png) |
| :------------------------------------------------: |

命令传播过程中，**从服务器A与主服务器断开连接了**，但是主服务器依然在执行客户端发来的指令，依然进行着命令传播

| ![img](mdpic/20201120175525-20240202110425897.png) |
| :------------------------------------------------: |

从服务器A尝试重连主服务器，某个时刻成功连上了。但是**它需要确定连上的主服务器是不是之前的主服务器**

| ![img](mdpic/20201120191548-20240202110425885.png) |
| :------------------------------------------------: |

确认是之前的主服务器后，开始**部分复制**操作

| ![img](mdpic/20201120175130-20240202110425908.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120192712-20240202110425897.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120194014-20240202110425911.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120200325-20240202110425911.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120200431-20240202110425922.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201120200930-20240202110425931.png) |
| :------------------------------------------------: |

如果此期间server1重新上线了，那么**它会降级成为从服务器**

| ![img](mdpic/20201120201001-20240202110425954.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122104850-20240202110425941.png) |
| :------------------------------------------------: |

| ![img](mdpic/20201122104856-20240202110425954.png) |
| :------------------------------------------------: |

Sentinel状态以及masters**字典**

| ![img](mdpic/20201122104917-20240202110425949.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122105405-20240202110425961.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122110153-20240202110425966.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122110831-20240202110425976.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122111758-20240202110425991.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122111958-20240202110425986.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122112131-20240202110425994.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122112310-20240202110426006.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122124243-20240202110426008.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122125242-20240202110426042.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201122130223-20240202110426026.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201123095602-20240202110426026.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201123095940-20240202110426036.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201123101417-20240202110426035.png) |
| :------------------------------------------------: |

**结构**

| ![img](mdpic/20201123101433-20240202110426037.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201123102913-20240202110426057.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201123103628-20240202110426057.png) |
| :------------------------------------------------: |
...
| ![img](mdpic/20201123103819-20240202110426068.png) |
| :------------------------------------------------: |