...
public class DocServiceTest {
    ...
    public void testDelDoc() throws IOException {
        ...
        docService.deleteDocWithId(indexName,"10");
    }
    ...
    public void testBuldInsertDoc() throws IOException {
        ...
        bulkRequestBuilder.add(new IndexRequest(indexName).id( String.valueOf(100)).source(JSON.toJSONString(smsSendLog6), XContentType.JSON));
