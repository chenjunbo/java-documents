...
public class BoolQueryTest {
    ...
    public void testBoostingQuery() throws InterruptedException, IOException {
        ...
        docService.add(indexName, JSON.toJSONString(smsSendLog),"17");
        ...
        docService.add(indexName, JSON.toJSONString(smsSendLog),"18");
        Thread.sleep(3000l);
        //都可以查出来，只是SCORE值减少，可以通过SCORE值来去掉排名在后面的
        boolQuery.boostingQuery(indexName);
    }
}
