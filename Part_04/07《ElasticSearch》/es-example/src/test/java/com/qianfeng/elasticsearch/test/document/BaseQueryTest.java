...
public class BaseQueryTest {
    ...
    public void testTerm() throws IOException {
        List<Map<String, Object>> list = baseQuery.termQuery(indexName, "province", "湖北省");
    ...
    public void testTerms() throws IOException {
        List<Map<String, Object>> list1 = baseQuery.termsQuery(indexName, "province", "湖北省","北京");
    ...
    public void testMatchsAll() throws IOException {
        baseQuery.queryAll(indexName);
    }

    @Test
    public void testQueryMatch() throws IOException {
        baseQuery.queryMatch(indexName,"smsContent","收货安装");
    }

    @Test
    public void testMatchWithOperate() throws IOException {
        baseQuery.queryMatchWithOperate(indexName, "smsContent", "中国 健康", Operator.AND);
        baseQuery.queryMatchWithOperate(indexName, "smsContent", "中国 健康", Operator.OR);
    }

    @Test
    public void testQueryMulitMatch() throws IOException {
        baseQuery.queryMulitMatch(indexName,"北京","smsContent","province");
    }
    ...
    public void testMatchPhrase() throws IOException, InterruptedException {
        ...
        docService.add(indexName, JSON.toJSONString(smsSendLog5),"200");
        ...
        docService.add(indexName, JSON.toJSONString(smsSendLog5),"300");
        //不是实时刷新，不休眠一下可能查不出来
        Thread.sleep(3000l);
        baseQuery.queryMatchPhrase(indexName,"smsContent","java spark");
    }

    @Test
    public void testIdsQuery() throws IOException, InterruptedException {
        baseQuery.idsQuery(indexName,"1","2","3");
    }

    @Test
    public void testPrefixQuery() throws IOException, InterruptedException {
        baseQuery.prefixQuery(indexName,"corpName","中国");
    }

    @Test
    public void testfuzzyQuery() throws IOException, InterruptedException {
        baseQuery.fuzzyQuery(indexName,"corpName","中国联动");
    }

    @Test
    public void testWildCardQuery() throws IOException, InterruptedException {
        baseQuery.wildCardQuery(indexName,"corpName","中国*");
        baseQuery.wildCardQuery(indexName,"corpName","学?思");
    }

    @Test
    public void testRangeCardQuery() throws IOException {
        baseQuery.rangeQuery(indexName,"replyTotal",1,20);
    }
    ...
    public void testRegexpQuery() throws IOException {
        ...
        baseQuery.regexpQuery(indexName,"longCode",regex);
    }

    @Test
    public void testScrollQuery() throws IOException {
        baseQuery.scrollQuery(indexName);
    }
//
//    @Test
...
//        baseQuery.moreLikeThisQuery(indexName,fields,likeTexts);
//    }
}
