...
public class HightLightQueryTest {
    ...
    public void testhightLightQuery() throws IOException {
        hightLightQuery.hightLightQuery(indexName,"smsContent","中国苹果");
    }
    ...
    public void testHightLightQueryByFragment() throws IOException, InterruptedException {
        ...
        docService.add(indexName, JSON.toJSONString(smsSendLog5),"220");
        Thread.sleep(2000);
        hightLightQuery.hightLightQueryByFragment(indexName,20);
    }

    @Test
    public void testHightLightQueryByNumOfFragments() throws IOException {
        hightLightQuery.hightLightQueryByNumOfFragments(indexName,20,2);
    }

    @Test
    public void testHightLightNoMatchSize() throws IOException {
        hightLightQuery.hightLightNoMatchSize(indexName,20,2,150);
    }
}
